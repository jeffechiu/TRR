class PlayerGamesController < ApplicationController
  ...
  private
    ...
    def player_game_params
      params.require(:player_game).permit(:player_id, :game_id, :champion_id, :kills, :deaths, :assists, :doubles, :triples, :quadras, :pentas, :fbkill, :fbdeath, :fbassist, :drakes, :herald, :barons, :dmg, :gold, :goldspent, :wardsplaced, :wardskilled, :viswards, :viswardbuys, :cs10, :oppcs10, :gold10, :oppgold10, :gold15, :oppgold15, :xp10, :oppxp10)
    end
end
