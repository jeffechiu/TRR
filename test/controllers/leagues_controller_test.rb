...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { abbrev: @league.abbrev, description: @league.description, logo: @league.logo, name: @league.name } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { abbrev: @league.abbrev, description: @league.description, logo: @league.logo, name: @league.name } }
