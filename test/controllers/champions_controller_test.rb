...
class ChampionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create champion" do
    assert_difference('Champion.count') do
      post champions_url, params: { champion: { class: @champion.class, name: @champion.name } }
    end
  ...
  test "should update champion" do
    patch champion_url(@champion), params: { champion: { class: @champion.class, name: @champion.name } }
